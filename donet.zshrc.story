...
P9K_CUSTOM_WIFI_SIGNAL_BACKGROUND="white"
P9K_CUSTOM_WIFI_SIGNAL_FOREGROUND="black"
zsh_wifi_signal(){
...
if zplug check "bhilburn/powerlevel9k"; then
    ...
    P9K_BATTERY_CHARGED='green'
    P9K_BATTERY_DISCONNECTED='$DEFAULT_COLOR'
    P9K_BATTERY_LOW_THRESHOLD='10'
    P9K_BATTERY_LOW_COLOR='red'
    P9K_MULTILINE_FIRST_PROMPT_PREFIX_ICON=''
    #P9K_BATTERY_STAGES=($'\u2581 ' $'\u2582 ' $'\u2583 ' $'\u2584 ' $'\u2585 ' $'\u2586 ' $'\u2587 ' $'\u2588 ')
    P9K_BATTERY_ICON='\uf1e6 '
    P9K_PROMPT_ON_NEWLINE=true
    #P9K_MULTILINE_LAST_PROMPT_PREFIX="❱ "
    #P9K_MULTILINE_LAST_PROMPT_PREFIX_ICON="%F{014}\u2570%F{cyan}\uF460%F{073}\uF460%F{109}\uF460%f "
    P9K_VCS_MODIFIED_BACKGROUND='yellow'
    P9K_VCS_UNTRACKED_BACKGROUND='yellow'
    P9K_VCS_UNTRACKED_ICON='?'
    
    P9K_LEFT_PROMPT_ELEMENTS=(os_icon context battery dir vcs)
    P9K_RIGHT_PROMPT_ELEMENTS=(status time dir_writable ip custom_wifi_signal ram load background_jobs)
    P9K_LOAD_CRITICAL_BACKGROUND="white"
    P9K_LOAD_WARNING_BACKGROUND="white"
    P9K_LOAD_NORMAL_BACKGROUND="white"
    P9K_LOAD_CRITICAL_FOREGROUND="red"
    P9K_LOAD_WARNING_FOREGROUND="yellow"
    P9K_LOAD_NORMAL_FOREGROUND="black"
